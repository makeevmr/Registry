...
def preprocess_project_data_with_llm(auth_token: str, data: pd.DataFrame) -> pd.DataFrame:
    ...
    for i in range(len(data)):
        ...
        proj_theme = llm_get_project_feature(llm_2, message, project_info, project_req, project_req_workers)
        ...
        proj_roles = llm_get_project_feature(llm_1, message, project_info, project_req, project_req_workers)
        ...
        proj_hard_skills = llm_get_project_feature(llm_1, message, project_info, project_req, project_req_workers)
        ...
        proj_roles_scoring = llm_get_project_feature(llm_1, message, project_info, project_req, project_req_workers)
