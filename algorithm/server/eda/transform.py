...
from eda.data_preparation import preprocess_project_data_with_llm
...
def transform_json_to_csv_project(json_data: dict, auth_token: str) -> pd.DataFrame:
    ...
    result_df = pd.DataFrame.from_dict(result_df_rows, orient="columns")
    result_df = preprocess_project_data_with_llm(auth_token, result_df)
    return result_df


# with open(
#     r'/Users/nadir/student_project/automatic_team_distribution/Datasets Analysis\data (2).json',
#     'r',
#     encoding='utf-8',
# ) as f:
#     print(transform_json_to_csv_student(json.load(f)).head())
...
#     encoding='utf-8',
# ) as f:
#     transform_json_to_csv_student(json.load(f))
